...
(function() {
  ...
  TwitterCldr.set_data = function(bundle) {
    var bundle_key, bundle_value, key, sub_bundle;
    TwitterCldr.data = bundle;
    for (key in bundle) {
      sub_bundle = bundle[key];
      for (bundle_key in sub_bundle) {
        bundle_value = sub_bundle[bundle_key];
        this[key][bundle_key] = bundle_value;
      }
    }
    return null;
  };
...
;
    ...
    PluralRules.rule_for = function(number, type) {
      ...
      try {
        return eval(this.rules[type])(number.toString(), this.runtime);
      } catch (_error) {
        error = _error;
        return "other";
      }
  ...
  TwitterCldr.TimespanFormatter = (function() {
    ...
    TimespanFormatter.prototype.patterns = function() {
      return TwitterCldr.TimespanFormatter.patterns;
    };
  ...
  TwitterCldr.DateTimeFormatter = (function() {
    ...
    DateTimeFormatter.tokens = TwitterCldr.get_data().DateTimeFormatter.tokens;

    DateTimeFormatter.prototype.tokens = function() {
      return TwitterCldr.DateTimeFormatter.tokens;
    };
  ...
  TwitterCldr.ListFormatter = (function() {
    ...
    ListFormatter.formats = {};

    ListFormatter.prototype.get_formats = function() {
      return TwitterCldr.ListFormatter.formats;
    };

    ListFormatter.prototype.format = function(list) {
      if (this.get_formats()[list.length.toString()] != null) {
        return this.compose(this.get_formats()[list.length.toString()], list);
      } else {
    ...
    ListFormatter.prototype.compose_list = function(list) {
      ...
      result = this.compose(this.get_formats().end || this.get_formats().middle || "", [list[list.length - 2], list[list.length - 1]]);
      if (list.length > 2) {
        for (i = _i = 3, _ref = list.length; 3 <= _ref ? _i <= _ref : _i >= _ref; i = 3 <= _ref ? ++_i : --_i) {
          format_key = i === list.length ? "start" : "middle";
          if (this.get_formats()[format_key] == null) {
            format_key = "middle";
          }
          result = this.compose(this.get_formats()[format_key] || "", [list[list.length - i], result]);
        }
      }
      return result;
    };
...
;
  ...
  TwitterCldr.BreakIterator = (function() {
    ...
    BreakIterator.tailoring_resource_data = {};

    BreakIterator.exceptions_resource_data = {};

    BreakIterator.root_resource = {};
    ...
    BreakIterator.prototype.resource_for = function(boundary_name) {
      return TwitterCldr.BreakIterator.root_resource["segments"][boundary_name];
    };

    BreakIterator.prototype.tailoring_resource_for = function(locale, boundary_name) {
      return TwitterCldr.BreakIterator.tailoring_resource_data[locale][locale]["segments"][boundary_name];
    };
  ...
  TwitterCldr.NumberParser = (function() {
    ...
    NumberParser.group_separator = {};

    NumberParser.decimal_separator = {};

    NumberParser.prototype.get_group_separator = function() {
      return TwitterCldr.NumberParser.group_separator;
    };

    NumberParser.prototype.get_decimal_separator = function() {
      return TwitterCldr.NumberParser.decimal_separator;
    };
    ...
    NumberParser.prototype.get_separators = function(strict) {
      ...
      group = strict ? this.get_group_separator() : this.separator_chars;
      decimal = strict ? this.get_decimal_separator() : this.separator_chars;
      return {
        group: group,
        decimal: decimal
      };
  ...
  TwitterCldr.CurrencyFormatter = (function(_super) {
    ...
    function CurrencyFormatter(options) {
      ...
      this.default_precision = this.get_currencies_data().DEFAULT.digits;
      CurrencyFormatter.__super__.constructor.apply(this, arguments);
    }

    CurrencyFormatter.currencies_data = {};

    CurrencyFormatter.prototype.get_currencies_data = function() {
      return TwitterCldr.CurrencyFormatter.currencies_data;
    };
    ...
    CurrencyFormatter.prototype.defaults_for_currency = function(currency) {
      return this.get_currencies_data()[currency] || this.get_currencies_data().DEFAULT;
    };
  ...
  TwitterCldr.RBNF = (function() {
    ...
    RBNF.prototype.get_resource = function() {
      return TwitterCldr.RBNF.resource;
    };
    ...
    RBNF.prototype.get_resource_for_locale = function(locale) {
      ...
      return this.get_resource()[locale];
    };
  ...
  TwitterCldr.NumberDataReader = (function() {
    ...
    NumberDataReader.resource = {};

    NumberDataReader.prototype.resource = function() {
      return TwitterCldr.NumberDataReader.resource;
    };
